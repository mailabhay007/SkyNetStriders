...
st.markdown("<h2>Hi, I am Skynet assistant. </h2>", unsafe_allow_html=True)
st.markdown("<h2>Ask me about anything related to :</h2>", unsafe_allow_html=True)
st.markdown("<h5>How is TCS Financial report 2024-2025?</h5>", unsafe_allow_html=True)
st.markdown("<h5>Information technology in India</h5>", unsafe_allow_html=True)
st.markdown("<h5>HCL</h5>", unsafe_allow_html=True)
st.markdown("<h5>Infosys</h5>", unsafe_allow_html=True)
st.markdown("<h5>Wipro</h5>", unsafe_allow_html=True)
# st.markdown("<h3>Yeah anything.</h3>", unsafe_allow_html=True)
st.markdown('<h5><i style="color: red;">You can read or listen to my response</i></h5>', unsafe_allow_html=True)
